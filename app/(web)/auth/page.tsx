  ...
  const loginHandler = async () => {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        <section className="container mx-auto">
           <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] md-auto">
            <div className="flex mb-8 flex-col md:flex-row items-center justify-between">
                <h1 className="text-xl font-bold leading-tight tracking-tight md:text-2xl">
                    ...
                    <span className="inline-flex items-center">
                        ...
                        className="mr-3 txt-4xl cursor-pointer text-black dark:text-white"/>|
                        <FcGoogle 
                        onClick={loginHandler} 
            ...
            <form className="space-y-4 md:space-y-6" onSubmit ={handleSubmit}>
                ...
                <input type="password" name="password" placeholder="password" required className={inputStyles} minLength={6} value={formData.password} onChange={handleInputChange}/>
